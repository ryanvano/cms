...
<?php
    ...
    $postCountQuery = "SELECT * FROM posts WHERE post_status='published' AND post_author = '$u_id'";
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-8">  
                ...
                $query = "SELECT posts.*, users.user_username FROM posts LEFT JOIN users ON posts.post_author = users.user_id WHERE post_status = 'published' AND post_author= {$u_id} LIMIT {$startPost}, {$postPerPage}";
