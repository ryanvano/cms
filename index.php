    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-8">  
                ...
                $page = 1;
                if(isset($_GET['page'])){
                    $startPost = ($_GET['page']*$postPerPage)-$postPerPage;
                    $page = $_GET['page'];
                } else {$startPost = 0;}
                

               $query = "SELECT posts.*, users.user_username FROM posts INNER JOIN users ON posts.post_author = users.user_id WHERE post_status = 'published' LIMIT {$startPost}, {$postPerPage}";
